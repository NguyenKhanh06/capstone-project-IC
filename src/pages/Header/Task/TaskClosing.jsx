...
const handleCloseConfirm = (data) => {
  ...
  return (
    ...
    >
      ...
      <CreateTask getDetail={fetchData} deadline={props.state.mileStoneProject.find(mil => mil.mileStoneId === 4)} projectid={state?.id} mileStoneId={5} show={showCreate} close={() => setShowCreate(false)} />
      <ListSubTask getDetail={fetchData} project={props.state} state={task} show={showDetail} close={() => setShowDetail(false)} />
    </>
  );
}

export default TaskClosing;
