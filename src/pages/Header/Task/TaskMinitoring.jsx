...
const handleCloseConfirm = (data) => {
  ...
  return (
    ...
    >
      ...
      <CreateTask getDetail={fetchData} deadline={props.state.mileStoneProject.find(mil => mil.mileStoneId === 4)} projectid={state?.id} mileStoneId={4} show={showCreate} close={() => setShowCreate(false)} />
      <ListSubTask project={props.state} state={task} show={showDetail} close={() => setShowDetail(false)} getDetail={fetchData}/>
    </>
  );
}

export default TaskMinotoring;
