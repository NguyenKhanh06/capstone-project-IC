...
const handleCloseConfirm = (data) => {
 ...
 <Typography>{props.state?.mileStoneProject?.dateBegin}</Typography>
 <Typography>{props.state?.mileStoneProject?.dateEnd}</Typography>
        </Stack>
...
export default TaskInitiationMember;
