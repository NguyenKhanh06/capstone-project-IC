...
import DetailSlotNego from './DetailSlotNegoPartner';
import RejectSlot from './RejectSlot';

function ListSlotNegoPartner(props) {
    ...
    <div  style={{marginTop: 40}}>
      ...
      >
        <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1a-content" id="panel1a-header">
          <Stack direction="row" justifyContent="space-between" alignItems="center" spacing={50}>
...
<DetailSlotNego show={showDetail} close={()=> setShowDetail(false)}/>
    ...
    <RejectSlot show={showReject} close={() => setShowReject(false)}/>

    </div>
  );
}

export default ListSlotNegoPartner;
