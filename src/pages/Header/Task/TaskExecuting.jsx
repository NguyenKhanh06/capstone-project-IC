...
const handleCloseConfirm = (data) => {
  ...
  return (
    ...
    >
      ...
      <CreateTask getDetail={fetchData} deadline={props.state.mileStoneProject.find(mil => mil.mileStoneId === 3)} projectid={state?.id} mileStoneId={3} show={showCreate} close={() => setShowCreate(false)} />
