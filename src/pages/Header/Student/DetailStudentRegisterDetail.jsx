...
function DetailStudentRegisterDetail(props) {
  ...
  const getDetail = async () => {
    await axios.get(`${API_URL}/registration/GetDetailResId/${props.studentID.id}`).then((response) => {
  ...
  const UpdateStudent = () => {
    ...
    axios({
      method: 'PUT',
      data: formData,
      url: `${API_URL}/registration/UpdateRegisId/${student.id}?FullName=${
        student.student.fullName
      }&Title=${title}&MajorId=${student?.student?.majorId}&memberCode=${student?.student?.memberCode}&PhoneNumber=${
